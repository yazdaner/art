                    ...
                    <div class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center">
                        ...
                        <div class="card-body">
                            <a href="https://atabakart.com/course/4" dideo-checked="true">
                                ...
                                <p class="text-muted mb-0">بعد از این دوره هر تصویر را می&zwnj;توانید با رنگ روغن نقاشی کنید.    </p>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center">
                        ...
                        <div class="card-body">
                            <a href="https://atabakart.com/course/3" dideo-checked="true">
                                ...
                                <p class="text-muted mb-0">این دوره، پایه و اساس یادگیری دوره&zwnj;های نقاشی و تصویرسازی است.  </p>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center">
                        ...
                        <div class="card-body">
                            <a href="https://atabakart.com/course/2" dideo-checked="true">
                                ...
                                <p class="text-muted mb-0">این دوره برای یادگیری طراحی حرفه&zwnj;ای در نقاشی دیجیتال آرت لازم است.     </p>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center">
                        ...
                        <div class="card-body">
                            <a href="https://atabakart.com/course/1" dideo-checked="true">
                                ...
                                <p class="text-muted mb-0">در این دوره با بهترین نرم افزارها، نقاشی دیجیتال آرت را یاد می&zwnj;گیرید.  </p>
                            </a>
                        </div>
                    </div>
                </div>
