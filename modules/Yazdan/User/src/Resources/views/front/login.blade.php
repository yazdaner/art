                        ...
                        <div class="card login-page bg-white shadow rounded border-0">
                            <div class="card-body">
                                <h4 class="card-title text-center">وارد شدن </h4>
                                                            <form class="login-form mt-4" method="post" action="./login.html">
                                    <input type="hidden" name="csrf" value="4c710785442a6a3d2c525fd5373afda946cea9f121eac97d372b0ce49343e5002bf249985d8311bc">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input type="password" name="password" class="form-control ps-5" placeholder="رمز عبور " required="">
                                                </div>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <p class="forgot-pass mb-0"><a href="./forgot.html" class="text-dark fw-bold">فراموشی رمز عبور؟ </a></p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="mb-0 mt-3"><small class="text-dark me-2">حسابی ندارید؟ </small> <a href="./register.html" class="text-dark fw-bold">ثبت نام کنید </a></p>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <!--end row-->
